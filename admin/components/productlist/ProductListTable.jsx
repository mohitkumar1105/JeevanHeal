...
const ProductListTable = () => {
	...
	const columns = [
						...
						
        {
			name: 'Product',			
			sortable: true,
			cell: row => <Media ><Media.Body className="d-flex"><h2 className="table-avatar"><Link className="avatar avatar-sm me-2 user-dt" to="#" data-bs-target="#editModal" data-bs-toggle="modal"><img className="avatar avatar-img" src={row.img_url2} alt="User Image"/></Link></h2><Link to="#"
			data-bs-target="#editModal"
			data-bs-toggle="modal"
			className="user-name">{row.Product}<br/><span>{row.Qtys}</span>
