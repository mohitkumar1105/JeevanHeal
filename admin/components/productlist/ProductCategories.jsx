					...
					<div className="page-header">
						<div className="row align-items-center">
							<div className="col-md-12 d-flex justify-content-end">
								<div className="doc-badge me-3">Total Categories <span className="ms-1">48</span></div>
					...
					<div className="modal-content doctor-profile">
						...
						<div className="modal-body">
							<form action="/admin/product-category">
								<div className="add-wrap">
									<div className="form-group form-focus">
										<input type="text" className="form-control floating" defaultValue="Neuromodulation"/>
										<label className="focus-label">Category Name<span className="text-danger">*</span></label>
									</div>
									<label className="mb-1">Category Image</label>
									<div className="change-photo-btn">
