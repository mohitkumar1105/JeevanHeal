  ...
  const data = [
    {
      ...
      call: (
        <i className="me-2">
          <FeatherIcon icon="video" /> {"Video call"}
        </i>
      ),
    ...
    },
    {
      ...
      call: (
        <i className="me-2">
          <FeatherIcon icon="message-square" /> {"chat"}
        </i>
      ),
      Date: "26 November 2022",
      time: "12/20/2022",
        ...
        <Media>
          <Media.Body className="d-flex">
            <Link to="/admin/profile" className="avatar avatar-sm me-2 user-dt">
              <img src={row.img_url} className="avatar avatar-img" />
            </Link>
            <div className="text-secondary">
              <span className="user-name">{row.Patient}</span>
              <br />
      ...
      cell: (row) => (
        <Media>
          <Media.Body className="d-flex">
            ...
            >
              <img src={row.img_url2} className="avatar avatar-img" />
            </Link>
            <div className="text-secondary">
              <span className="text-muted">{row.Doctor}</span>
              <br />
