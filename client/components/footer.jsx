...
const Footer = (props) => {
  ...
  return (
    <> {  (!props.location.pathname.includes("/home4") && !props.location.pathname.includes("/home6") && !props.location.pathname.includes("/home7") && !props.location.pathname.includes("/home8")) && 
