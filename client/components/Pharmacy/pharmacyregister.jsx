                            ...
                            <div className="row align-items-center justify-content-center">
                                ...
                                <div className="col-md-12 col-lg-6 login-right">
                                    <div className="login-header">
                                        <h3>Pharmacy Register <Link to="/doctor/doctor-register" >Are you a Doctor?</Link></h3>
                                    </div>
                                    
                                  
                                    <form action="/Pharmacy/pharmacy-registerstep-1">
                                        ...
                                        <div className="row form-row social-login">
                                            <div className="col-6">
                                                <a href="#0" className="btn btn-facebook w-100"><i className="fab fa-facebook-f me-1"></i> Login</a>
                                            </div>
                                            <div className="col-6">
                                                <a href="#0" className="btn btn-google w-100"><i className="fab fa-google me-1"></i> Login</a>
                                            </div>
                                        </div>
                                    </form>
